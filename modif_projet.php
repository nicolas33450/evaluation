<?php
session_start();
function affiche_creation_projet($nom = '',$code = '', $description ='', $debut = '', $fin ='', $avancement ='', $verif = false){
    ?>
<form action="creation_projet.php" method="post">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-md-3 pt-3 text-center">
                <label class="control" for="idav"> Avancement : </label>
            </div>   
            <div class="col-12 col-md-3">
                <input class="form-control mt-3" type="text" name="avancement" id="idav" placeholder="avancement"  value="<?= $avancement ?>" require/>
            </div>
...
<html lang="fr">
    ...
    <body>        
        ...
        if(isset($_POST['enregistrer']))
        {
            ...
            $av = trim($_POST['avancement']);           
            
            if(empty($n) || empty($c) || empty($d) || empty($dd) || empty($df) || empty($av)) //empty remplace le == ''
            {

                affiche_creation_projet($n, $c, $d, $dd, $df, $av, true);
                ...
                if($av == '')
                {
                    echo 'veuillez saisir un avancement de projet <br/>';
                }                           
            }
            else
            { 
                  ...
                  $requete = $pdo->prepare("update projet set nom_projet = :nom, id_utilisateur = :code, description = :description, date_debut_projet = :date_de_debut,
                                            date_fin_projet = :date_de_fin, avancement = :avancement where nom = :code");
                  ...
                  $requete->bindValue(':avancement', $av);
